...
/* Define to 1 if you have the declaration of `READ_IMPLIES_EXEGC', and to 0 if
   you don't. */
...
#define LIBBLKID_DATE "06-Apr-2010"

/* libblkid version string */
#define LIBBLKID_VERSION "2.17.0"
...
#define PACKAGE_STRING "util-linux-ng 2.17.1"
